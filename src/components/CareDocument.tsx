  ...
  if (selectedPlants.length === 0) {
    return (
      <div className="mx-auto max-w-2xl px-4 py-16 text-center">
        <p className="font-display text-xl font-semibold text-klr-900">No plants selected yet</p>
        <p className="mt-2 text-sm text-gray-500">
          Select plants from the catalog and they'll appear here, ready to export as a client care
          document.
        </p>
    ...
    <div className="mx-auto max-w-4xl px-4 py-6">
      <div className="no-print mb-6 flex flex-wrap items-center gap-3">
        ...
        <div className="ml-auto flex gap-2">
          ...
          <button onClick={handleExportDocx} disabled={exporting} className="btn-primary">
            <FileDown className="h-4 w-4" /> {exporting ? "Building…" : "Export Word (.docx)"}
          </button>
        </div>
      </div>

      <div className="no-print card mb-6 grid grid-cols-1 gap-3 p-4 sm:grid-cols-2">
        <input
          className="input"
